...
## Unreleased
### Added
- Configuration.get_option() returns converted option value if the option was assigned a type (int, float, boolean). PluginConfiguration.init_option_types() is added to enable option typing in plugins. (#56)
### Changed
### Deprecated
### Removed
### Fixed
