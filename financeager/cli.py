...
def _parse_command(args=None):
    ...
    parser = argparse.ArgumentParser(description="An application (possibly running as Flask webservice) that helps you administering your daily expenses and earnings.")
