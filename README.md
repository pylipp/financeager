...
[![Python: 3.11+](https://img.shields.io/badge/Python-3.11+-blue.svg)](https://pypi.org/project/financeager)
...
`financeager` requires Python 3.11 or higher.
...
- `v1.6.3` is the last version to support Python 3.10
